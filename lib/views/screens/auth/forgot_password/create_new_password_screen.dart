        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Container(
                  margin: EdgeInsets.only(left: 20.px,right: 20.px,top: 10.px,bottom: 10.px),
                  child: AppTextField.appTextField(context, hintText: "New Password",
                    isObsecure: true,

                    suffixIcon: Icon(Icons.remove_red_eye_outlined,color: AppColors().grey),
              ...
              Container(
                  margin: EdgeInsets.only(left: 20.px,right: 20.px,top: 10.px,bottom: 10.px),
                  child: AppTextField.appTextField(context, hintText: "Confirm New Password",
                    isObsecure: true,
              ...
              GestureDetector(
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                        margin: EdgeInsets.symmetric(horizontal: 25.px, vertical: 20.px),
                        height: 50.px,
                        ...
                        child: Text('Save', style: AppFontStyle().titleS(color: AppColors().white))),
                  ],
                ),
              ),
